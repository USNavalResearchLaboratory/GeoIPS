...
# 20160126 MLS  UNCHANGED Pulled from github pytroll scheduler.  This will replace
#                   pyresample/spherical_geometry.py
#               Allows use of SphPolygon, for defining polygons with more
#                   than 4 corners, rather than relying on 4 corners.
#               Step 3 will be to use SphPolygon with lots of vertices
#                   for AHI, since it does not have great circle boundaries.
...
class SphPolygon(object):
    ...
    def area(self):
        ...
        .. [bev1987] , Michael Bevis and Greg Cambareri, "Computing the area of a spherical polygon of arbitrary shape", in *Mathematical Geology*, May 1987, Volume 19, Issue 4, pp 336.
    ...
    def _is_inside(self, other):
        ...
        with :meth:`inter` firscheck if the is a known intersection.
        """
